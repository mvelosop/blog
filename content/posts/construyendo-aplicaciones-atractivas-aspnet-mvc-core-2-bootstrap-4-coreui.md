---
title: Construyendo aplicaciones atractivas con ASP.NET MVC Core 2 y Bootstrap 4 usando CoreUI
draft: true
author: Miguel Veloso
date: 2017-11-03
description: Adaptar una plantilla de BS 4 a una aplicación MVC básica, para mejorar la experiencia del usario
thumbnail: posts/images/interior-2245657_1280.jpg
categorías: [ "Desarrollo" ]
tags: [ "Entity Framework Core", "User Experience", "Client Side Development" ]
series: [  ]
...
* El perfil de usuario desde la opción "Profile" en el menú del usuario
* El cierre de sesión en la opción "Logout" en el menú del usuario
